        ...
        return YetAnotherConfigLib.create(CONFIG, ((defaults, config, builder) -> builder
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(Option.<Integer>createBuilder()
                                ...
                                .description(OptionDescription.of(Component.translatable("betterscreens.container-scale.description")))
                                .binding(-1, () -> config.containerScale, newVal -> config.containerScale = newVal)
                                .controller(opt -> IntegerSliderControllerBuilder.create(opt)
                                        .formatValue(value -> Component.literal(value == -1 ? "OFF" : value == 0  ? "AUTO" : String.valueOf(value)))
                                        .range(-1, 5)
                                        .step(1))
                                .build())
                        .option(Option.<Boolean>createBuilder()
